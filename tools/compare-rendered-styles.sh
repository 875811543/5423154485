...
#
#   usage: tools/compare-rendered-styles.sh [ref]      (ref par defaut : HEAD)
#
...
probe() { # <dir> <slug> <out>
  ...
  "$CHROME" --headless=new --disable-gpu --hide-scrollbars --window-size=1280,3000 \
...
echo "pages identiques : $ok/$(ls *.html | wc -l)"
